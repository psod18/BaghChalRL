...
for epoch in range(1, epochs+1):
    ...
    game_env.restart()
    if epoch % 1000 == 0:
        print(f"W: {history['wolves']}, S: {history['sheep']}")

game_env.wolves.save(path=r"F:\python\bagh_chal\utils\agents", filename="q-wolves1")
game_env.sheep.save(path=r"F:\python\bagh_chal\utils\agents", filename="q-sheep1")
